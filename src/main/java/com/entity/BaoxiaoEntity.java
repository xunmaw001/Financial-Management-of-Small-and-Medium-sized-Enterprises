...
public class BaoxiaoEntity<T> implements Serializable {
     ...
     * 是否上交
     */
    @TableField(value = "baoxiao_shangjiao_types")

    private Integer baoxiaoShangjiaoTypes;
	 ...
	 * 设置：是否上交
	 */
    public Integer getBaoxiaoShangjiaoTypes() {
        return baoxiaoShangjiaoTypes;
    }
    ...
    public void setBaoxiaoShangjiaoTypes(Integer baoxiaoShangjiaoTypes) {
        this.baoxiaoShangjiaoTypes = baoxiaoShangjiaoTypes;
    }
    /**
	 * 设置：是否批准
	 */
    ...
    public String toString() {
        return "Baoxiao{" +
            ...
            ", baoxiaoShangjiaoTypes=" + baoxiaoShangjiaoTypes +
