            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">报销信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="baoxiaoName" name="baoxiaoName" class="form-control"
                                               v-model="ruleForm.baoxiaoName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>报销类型</label>
                                    <input id="baoxiaoValue" name="baoxiaoValue" class="form-control"
                                           v-model="ruleForm.baoxiaoValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="baoxiaoMoney" name="baoxiaoMoney" class="form-control"
                                               v-model="ruleForm.baoxiaoMoney" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>是否上交</label>
                                    <input id="baoxiaoShangjiaoValue" name="baoxiaoShangjiaoValue" class="form-control"
                                           v-model="ruleForm.baoxiaoShangjiaoValue" readonly>
                                </div>


                                <div class="form-group col-md-6">
                                    <label>是否批准</label>
                                    <input id="baoxiaoYesnoValue" name="baoxiaoYesnoValue" class="form-control"
                                           v-model="ruleForm.baoxiaoYesnoValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.baoxiaoContent != null && ruleForm.baoxiaoContent != 'null' && ruleForm.baoxiaoContent != '') {
