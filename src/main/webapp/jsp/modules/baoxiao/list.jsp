...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">报销信息管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">报销信息列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">报销信息列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="baoxiaoNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="报销名目" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //报销名目
            var baoxiaoNameSearchInput = $('#baoxiaoNameSearch');
            if( baoxiaoNameSearchInput != null){
                if (baoxiaoNameSearchInput.val() != null && baoxiaoNameSearchInput.val() != '') {
                    searchForm.baoxiaoName = $('#baoxiaoNameSearch').val();
                }
            }
                                        getDataList();
        }
        ...
        function getDataList() {
            http("baoxiao/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                baoxiaoName: searchForm.baoxiaoName,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //报销名目
            var baoxiaoNameCell = document.createElement('td');
            baoxiaoNameCell.innerHTML = item.baoxiaoName;
            row.appendChild(baoxiaoNameCell);


            //报销类型
            var baoxiaoTypesCell = document.createElement('td');
            baoxiaoTypesCell.innerHTML = item.baoxiaoValue;
            row.appendChild(baoxiaoTypesCell);
            ...
            //报销金额
            var baoxiaoMoneyCell = document.createElement('td');
            baoxiaoMoneyCell.innerHTML = item.baoxiaoMoney;
            row.appendChild(baoxiaoMoneyCell);


                //提交备注
            var baoxiaoContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.baoxiaoContent && item.baoxiaoContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.baoxiaoContent.indexOf('<img');
                var endIndex = item.baoxiaoContent.indexOf('>');
                    baoxiaoContentCell.innerHTML = item.baoxiaoContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.baoxiaoContent != null && item.baoxiaoContent != "" && item.baoxiaoContent.length >= 11) {
                        baoxiaoContentCell.innerHTML = item.baoxiaoContent.substring(0, 10) + "...";
                } else {
                        baoxiaoContentCell.innerHTML = item.baoxiaoContent;
                }
            }
            row.appendChild(baoxiaoContentCell);


            //是否上交
            var baoxiaoShangjiaoTypesCell = document.createElement('td');
            baoxiaoShangjiaoTypesCell.innerHTML = item.baoxiaoShangjiaoValue;
            row.appendChild(baoxiaoShangjiaoTypesCell);


            //是否批准
            var baoxiaoYesnoTypesCell = document.createElement('td');
            baoxiaoYesnoTypesCell.innerHTML = item.baoxiaoYesnoValue;
            row.appendChild(baoxiaoYesnoTypesCell);
            ...
            if(window.sessionStorage.getItem('role') == '财务经理'  && item.baoxiaoShangjiaoTypes == 1){
            ...
            }else if(window.sessionStorage.getItem('role') == '管理员' && item.baoxiaoShangjiaoTypes ==2 && item.baoxiaoYesnoTypes ==1){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("baoxiao/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addbaoxiao", "addbaoxiao");
            window.location.href = "add-or-update.jsp"
        }
